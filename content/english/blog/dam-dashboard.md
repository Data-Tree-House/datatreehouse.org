...
meta_title: "South Africa Dam Dashboard"
description: "Using Streamlit to build a dam dashboard"
date: 2025-02-02T10:00:00Z
image: "/images/thumbnails/dam-dashboard.png"
...
<video controls width="100%">
	<source
		src="/images/dam-dashboard/dam_dash_demo.mp4"
		type="video/mp4">
...
{{< button label="Go To App" link="https://sadamlevels.com" style="solid" >}}

## 👨‍🔬 Architecture


![sa-dam-dash-architecture.png](/images/dam-dashboard/sa-dam-dash-architecture.png)
...
![dam_dash_indexes.png](/images/dam-dashboard/dam_dash_indexes.png)
...
![if_things_feel_slow.png](/images/dam-dashboard/if_things_feel_slow.png)
## ❓ Conclusion
